        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 py-16 border-b border-[#2a2a3a]">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex gap-3 mt-1">
              <a
                ...
                aria-label="GitHub"
                className="w-9 h-9 rounded-lg border border-[#2a2a3a] flex items-center justify-center text-slate-500 hover:text-orange-400 hover:border-orange-500/60 hover:bg-orange-500/10 transition-all duration-200"
              >
                <GitHubIcon size={18} />
              </a>
              <a
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              <li>
                <Link
                  to="/"
                  className="group flex items-center gap-2 text-slate-500 hover:text-white text-sm transition-colors duration-200"
                >
                  <span className="w-0 group-hover:w-3 h-px bg-orange-400 transition-all duration-300 overflow-hidden" />
                  Home
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-slate-500 hover:text-white text-sm transition-colors duration-200"
                >
            ...
            <div className="mt-8">
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 text-sm font-medium text-white bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 px-5 py-2.5 rounded-xl transition-all duration-200"
              >
                Get In Touch
